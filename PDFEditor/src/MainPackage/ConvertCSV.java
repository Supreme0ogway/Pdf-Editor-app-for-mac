...
public class ConvertCSV {
  ...
  public ConvertCSV(Stage primaryStage, Group root) {
      this.primaryStage = primaryStage;
      this.root = root;
  }

  public void start() {
      primaryStage.setTitle("Convert PDF to CSV");
    ...
    //combine button
      ...
      combineButton.setOnAction(event -> {
          ...
          if(!filePaths.isEmpty() && filePaths.size() == 1) {
        	  ConvertToCSVProcess convert = new ConvertToCSVProcess();
        	  convert.setPdfFilePath(filePaths.get(0));
        	  
        	  //get the file name
        	  String fileName;
        	  if(fileNameTextField.getText().isEmpty()) {
        		  fileName = "PDFtoCSV.csv";
        	  } else {
        		  fileName = fileNameTextField.getText() + ".csv";
        	  }
        	  ...
        	  convert.setCSVFilePath(wordFilePath);
