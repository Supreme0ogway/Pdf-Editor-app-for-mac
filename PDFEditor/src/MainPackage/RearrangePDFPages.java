...
public class RearrangePDFPages {
  private Stage primaryStage;
  private Group root;
  private boolean fileHovering = false;
  
  public RearrangePDFPages(Stage primaryStage, Group root) {
      this.primaryStage = primaryStage;
      this.root = root;
  }

  public void start() {
      primaryStage.setTitle("Re-arrange PDF Pages");
      ...
      // Message
      Text message = new Text("Swap PDF Pages");
      ...
      Page1Swap.setPromptText("Enter page number.");
      Page1Swap.setTranslateX(340);
      Page1Swap.setTranslateY(286);
      
      //from___ to ____
      TextField Page2Swap = new TextField();
      Page2Swap.setPromptText("Enter page number.");
      Page2Swap.setTranslateX(340);
   ...
   // Add dropped files to the VBox
    ...
    //combine button
      Button combineButton = new Button("Arrange");
    	  ...
    	  if(Page1Swap.getText().isEmpty() || Page2Swap.getText().isEmpty() || 
    		...
    		// Use the filePaths list for further processing (e.g., combining the files)
              ...
              if(!filePaths.isEmpty() && filePaths.size() == 1) {
            	  RearrangePDFPagesProcess convert = new RearrangePDFPagesProcess();
